 ...
 * <p>TODO 传surface给MediaCodec来生成视频
 ...
 */
public class EncodeAndMuxTest extends TestCase {
    ...
    // encoder / muxer state
    private MediaCodec mEncoder;// TODO: 2017/10/25 编解码器
    private CodecInputSurface mInputSurface;// TODO: 2017/10/25 自己写的纹理输入工具
    private MediaMuxer mMuxer;// TODO: 2017/10/25 混编器
    private int mTrackIndex;//轨迹
    private boolean mMuxerStarted;//开关

    // allocate one of these up front so we don't need to do it every time
    private MediaCodec.BufferInfo mBufferInfo;// TODO: 2017/10/25 解码信息buf
    /**
